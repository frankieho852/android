...
class BusinessRegisterShopPage extends StatefulWidget {
  final String email;
  ...
  @override
  _BusinessRegisterShopPageState createState() =>
      _BusinessRegisterShopPageState();
}

class _BusinessRegisterShopPageState extends State<BusinessRegisterShopPage> {
  String _name, _category, _phone, _sDescription, _lDescription;
  ...
  List<Widget> _buildFormInput(BuildContext context) {
    return [
      ...
      /*Padding(
        padding: const EdgeInsets.symmetric(vertical: 8.0),
        child: DropdownField(
          listItem: ["Category 1", "Category 2", "Sports", "Music"],
          fieldName: "Category",
      ...
      Padding(
        ...
        child: TextInputField(
          ...
          validator: (input) => _validateTextInput(
              input.isEmpty || !validPhone.hasMatch(input), "phone"),
      ...
      Padding(
        ...
        child: LongTextInputField(
          ...
          onSaved: (input) => _lDescription = input,
          validator: (input) => _validateTextInput(
              input.isEmpty || !validCharacters.hasMatch(input),
              "lDescription"),
      ...
      for (var i in paymentOptions)
        CheckboxField(
          initialInfo: paymentdetail,
          fieldOption: i,
          onCheck: (option) => {_payments[i] = paymentdetail},
