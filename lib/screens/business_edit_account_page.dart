...
class BusineesEditAccountPage extends StatefulWidget {
  final String fullname;
  final String iconUrl;

  @override
  BusineesEditAccountPage({
    Key key,
    this.fullname,
    this.iconUrl,
  }) : super(key: key);
  ...
  @override
  _BusineesEditAccountPageState createState() =>
      _BusineesEditAccountPageState();
}

class _BusineesEditAccountPageState extends State<BusineesEditAccountPage> {
  String _name;
  File _icon;
