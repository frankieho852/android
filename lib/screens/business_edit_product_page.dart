...
class BusinessEditProductPage extends StatefulWidget {
  ...
  @override
  _BusinessEditProductPageState createState() =>
      _BusinessEditProductPageState();
}

class _BusinessEditProductPageState extends State<BusinessEditProductPage> {
  ...
  Future<void> _getName() async {
    ...
    FirebaseFirestore.instance
        ...
        .listen((detailData) {
      setState(() {
        String getshopname = detailData.get("name");
            ...
            postImage(imageFile, productname, categoryname).then((downloadUrl) {
              ...
              if (imageUrls.length == images.length) {
                if (((productprice != null) && (productprice != 0)) &&
                    ((productquantity != null) && (productquantity != 0.0))
    ...
    return [
      ...
      Padding(
        ...
        child: TextInputField(
          ...
          isCustomer: false,
          initialValue: widget.totalQuantity.toString(),
        ),
      ),
      Padding(
        padding: const EdgeInsets.symmetric(vertical: 8.0),
        child: LongTextInputField(
          ...
          validator: (input) => _validateTextInput(
              input.isEmpty || !validCharacters.hasMatch(input), "description"),
